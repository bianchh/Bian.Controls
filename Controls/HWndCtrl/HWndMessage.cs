...
namespace Bian.Controls.HWndCtrl
{
    internal class HWndMessage
    {
        ...
        public HWndMessage(string message, int row, int column, int size, string color)
        {
        ...
        public HWndMessage(string message, int row, int column)
        {
            this.message = message;
            this.row = row;
            this.column = column;
        ...
        {
            disp_message(Window, message, coordSystem, row, column, color, "false");
        }
