...
{
    public class HWndCtrl : IDisposable
    {
        #region --字段--
        private const int MAX_NUM_OBJ_LIST = 100;
        ...
        ToolStripMenuItem showCross_strip;
        ...
        /// </summary>
        internal ROIController roiManager;
        ...
        {
            ShowMessageEvent?.Invoke(this, e);
        }
        ...
        public HWndCtrl(HWindowControl view)
        {
            ...
            view.HalconWindow.SetDraw("fill");
            ...
            roiManager.SetViewController(this);
            ...
            MoveWindowEnable_strip.Click += new EventHandler((s, e) => { isMoveEnable = !isMoveEnable; });
            ...
            showCross_strip = new ToolStripMenuItem("显示/隐藏十字");
            showCross_strip.Click += new EventHandler((s, e) => ShowCross());
            showCross_strip.CheckOnClick = true;
            ...
            hv_MenuStrip.Items.Add(showCross_strip);
        ...
        private void View_SizeChanged(object sender, EventArgs e)
        {
            ...
            windowWidth = hWindowControl.Width;
            windowHeight = hWindowControl.Height;
            ResetWindow();
            Repaint();
        }
        ...
        private void ShowHistogram_strip_Click(object sender, EventArgs e)
        {
            ...
            HWndMessage message = new HWndMessage("鼠标左键电机并拉取矩形区域，鼠标右键完成", 20, 20, 20, "green");
        ...
        private void mouseUp(object sender, HalconDotNet.HMouseEventArgs e)
        {
            ...
            if (roiManager != null
                ...
                && (showMode == ShowMode.IncludeROI))
            {
                roiManager.TriggerROINotifyEvent(new ViewEventArgs(ViewMessage.UpdateROI));
            }
        }
        ...
        private void mouseMoved(object sender, HMouseEventArgs e)
        {
            ...
            try
            {
                ...
                if (!_isXOut && !_isYOut)
                {
                    ...
                    {
                        double grayVal;
                        grayVal = image.GetGrayval((int)currY, (int)currX);
            ...
            try
            {
                ...
                foreach (var item in HObjList)
                {
                    ...
                    else if (item.Message != null && isShowMessage)
                    {
                        ...
                        double sizeTmp = item.Message.ChangeDisplayFontSize(window, (1.0) / ZoomWndFactor, currentTextSize);
        ...
        internal void AddIconicVar(HWndMessage message)
        {
            HObjectEntry entry;
            if (message == null)
            {
        ...
        {
            HObjList.RemoveAll(p => p.Message != null);
        }
        ...
        public void SetBackgroundColor(string color)
        {
            ...
            viewPort.HalconWindow.SetWindowParam("background_color", backgroundColor);
            Repaint();
        }
        ...
        {
            viewPort.HalconWindow.SetColor(color);
        }
